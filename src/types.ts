...
export interface Order { id:string; number:string; client:string; city:string; date:string; qty025:number; qty15:number; free025:number; flyers:number; note:string; status:OrderStatus; packed:PackedChecks; stockDeducted:boolean }
