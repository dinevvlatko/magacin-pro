...
export type PackageQrItem = 'regular025'|'bib15'|'free025'|'free15'
export type ScannedPackages = Partial<Record<PackageQrItem,number[]>>
export interface Order { id:string; number:string; client:string; city:string; date:string; qty025:number; qty025Pieces?:number; qty15:number; qty15Pieces?:number; free025:number; free025Pieces?:number; free15?:number; free15Pieces?:number; flyers:number; note:string; status:OrderStatus; packed:PackedChecks; stockDeducted:boolean; scannedPackages?:ScannedPackages }
