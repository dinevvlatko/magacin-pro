...
export const PageHeader=({title,action}:{title:string;action?:ReactNode})=><div className="page-head"><div><h1>{title}</h1><p>K2 Vita • магацин и испорака</p></div>{action}</div>
