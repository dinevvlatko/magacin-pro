...
export const hydrateState=(state:AppState):AppState=>ensureDocumentArchive({...state,orders:state.orders.map(o=>{const hydrated={...o,qty025Pieces:o.qty025Pieces||0,qty15Pieces:o.qty15Pieces||0,free025Pieces:o.free025Pieces||0,free15:o.free15||0,free15Pieces:o.free15Pieces||0,packed:{...o.packed,free15:o.packed.free15||false}};return activeStatuses.has(hydrated.status)&&allPacked(hydrated)?{...hydrated,status:'Спакувана'}:hydrated})})
