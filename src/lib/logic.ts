...
export const allowedTransitions:Record<OrderStatus,OrderStatus[]>={
 ...
 'Спакувана':['Излезена','Испратена','Откажана'],
