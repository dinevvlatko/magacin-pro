...
export const allowedTransitions:Record<OrderStatus,OrderStatus[]>={
 'Чека залиха':['Нова','Откажана'],
 'Нова':['Во подготовка','Откажана'],
 'Во подготовка':['Спакувана','Откажана'],
 'Спакувана':['Излезена','Откажана'],
 'Излезена':['Испратена','Откажана'],
 'Испратена':['Доставена','Откажана'],
 'Доставена':[],
 'Откажана':[],
}
...
export const hydrateState=(state:AppState):AppState=>rebalanceReservations(ensureDocumentArchive({...state,stockThresholds:state.stockThresholds||{p025:300,p15:60,flyers:500},orders:state.orders.map(o=>{const hydrated={...o,qty025Pieces:o.qty025Pieces||0,qty15Pieces:o.qty15Pieces||0,free025Pieces:o.free025Pieces||0,free15:o.free15||0,free15Pieces:o.free15Pieces||0,packed:{...o.packed,free15:o.packed.free15||false}};return reservingStatuses.has(hydrated.status)&&allPacked(hydrated)?{...hydrated,status:'Спакувана'}:hydrated})}))
