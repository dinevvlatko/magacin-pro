...
export const demoState=():AppState=>({warehouse:{p025:{packages:150,pieces:0,total:2250,perPackage:15},p15:{packages:86,pieces:0,total:516,perPackage:6},flyers:2500},stockThresholds:{p025:300,p15:60,flyers:500},warehouseLedgerVersion:2,orders:demoOrders.map(o=>({...o,id:crypto.randomUUID(),packed:{...o.packed}})),clients:demoClients.map(c=>({...c,id:crypto.randomUUID()})),movements:[]})
